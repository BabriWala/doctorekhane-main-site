...
export default function DoctorDirectoryPage() {
  const initial = { search: "", specialization: ALL, city: ALL, gender: ALL, minExperience: "", telemedicine: false, sort: "rating" };
  ...
  useEffect(() => {
    const timer = setTimeout(async () => {
      try {
        ...
        for (const key of ["specialization", "city", "gender"]) if (filters[key] !== ALL) params[key] = filters[key];
